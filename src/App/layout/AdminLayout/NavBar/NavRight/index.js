...
class NavRight extends Component {
    ...
    constructor(props){
        ...
        this.state ={
            userName : sessionStorage.getItem('react_name')
        }
    ...
    render() {
        ...
        const md_userInfo =this.props.md_userInfo;
        return (
            <Aux>
                        ...
                        <Dropdown alignRight={!this.props.rtlLayout} className="drp-user">
                            ...
                            <Dropdown.Menu alignRight className="profile-notification">
                                <div className="pro-head">
                                    ...
                                    <span>{(userName)? userName :md_userInfo.name}</span>
                                    <a href="/auth/signin" onClick={this.doLogout} className="dud-logout" title="Logout">
...
const mapStateToProps = state => {
    return {
        md_userInfo: state.md_userInfo
    }
};

const mapDispatchToProps = dispatch => {
    return {
        // signUp: (data) => dispatch({ type: actionTypes.SIGN_UP, value: { data: data } }),
    }
};
