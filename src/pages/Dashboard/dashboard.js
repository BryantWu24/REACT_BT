...
import { apiAuthUserInfoGetOnlineUser } from '../../core/api';
...
class Dashboard extends React.Component {
    ...
    getUserInfo = () => {
        apiAuthUserInfoGetOnlineUser({
            headers: {
                'token': sessionStorage.getItem('react_tkn')
            }
        }).then((res) => {
            
        }).catch((e) => {
            toast.error("Omg...This is error. CatchError = " + e);
